...
namespace RSDN
{
    ...
    public class RusCurrency
    {
        ...
        static RusCurrency()
        {
            Register("Тонна", false, "тонна", "тонны", "тонн", "килограмм", "килограмма", "килограммов");
        ...
        public static string Str(float val)
        {
            return Str(val, "RUR");
        }

        public static string Str(float val, string currency)
        {
        ...
        public static string Str(float val, bool male,
            string seniorOne, string seniorTwo, string seniorFive,
            string juniorOne, string juniorTwo, string juniorFive)
        {
            bool minus = false;
            ...
            int n = (int)val;
            int remainder = (int)((val - n + 0.0005) * 1000);
            ...
            r.Append(remainder.ToString("000 "));
